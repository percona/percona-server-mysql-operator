...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SidecarBackupConfig) DeepCopyInto(out *SidecarBackupConfig) {
	*out = *in
	out.S3 = in.S3
	out.GCS = in.GCS
	out.Azure = in.Azure
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SidecarBackupConfig.
func (in *SidecarBackupConfig) DeepCopy() *SidecarBackupConfig {
	if in == nil {
		return nil
	}
	out := new(SidecarBackupConfig)
	in.DeepCopyInto(out)
	return out
}
