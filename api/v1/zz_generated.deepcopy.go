...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterSetClusters) DeepCopyInto(out *ClusterSetClusters) {
	*out = *in
	if in.Endpoints != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterSetClusters.
func (in *ClusterSetClusters) DeepCopy() *ClusterSetClusters {
	if in == nil {
		return nil
	}
	out := new(ClusterSetClusters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PerconaServerMySQLClusterSetSpec) DeepCopyInto(out *PerconaServerMySQLClusterSetSpec) {
	*out = *in
	...
	if in.Clusters != nil {
		...
		*out = make([]ClusterSetClusters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
