...
func (in *CreateReplicaClusterOptions) DeepCopyInto(out *CreateReplicaClusterOptions) {
	*out = *in
	if in.RecoveryMethod != nil {
		in, out := &in.RecoveryMethod, &out.RecoveryMethod
		*out = new(string)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MysqlShellRunner) DeepCopyInto(out *MysqlShellRunner) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MysqlShellRunner.
func (in *MysqlShellRunner) DeepCopy() *MysqlShellRunner {
	if in == nil {
		return nil
	}
	out := new(MysqlShellRunner)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PerconaServerMySQLClusterSetSpec) DeepCopyInto(out *PerconaServerMySQLClusterSetSpec) {
	*out = *in
	...
	if in.AllowForcedFailover != nil {
		in, out := &in.AllowForcedFailover, &out.AllowForcedFailover
		*out = new(bool)
		**out = **in
	}
	if in.Clusters != nil {
	...
	in.CreateReplicaClusterOptions.DeepCopyInto(&out.CreateReplicaClusterOptions)
