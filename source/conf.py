...
project = u'Percona Kubernetes Operator for Percona Server for MySQL'
...
html_title = 'Percona Kubernetes Operator for Percona Server for MySQL Documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Percona Kubernetes Operator for Percona Server for MySQL Documentation'
...
htmlhelp_basename = 'psoperatorps'
...
latex_documents = [
  ('index', 'percona-kubernetes-operator-for-ps.tex', u'Percona Kubernetes Operator for Percona Server for MySQL',
...
man_pages = [
    ('index', 'percona-kubernetes-operator-for-ps', u'Percona Kubernetes Operator for Percona Server for MySQL',
