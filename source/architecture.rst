...
* `MySQL Router <https://dev.mysql.com/doc/mysql-router/8.0/en/>`_, a proxy solution used when `group replication <https://dev.mysql.com/doc/refman/8.0/en/group-replication.html>`_ between MySQL instances :ref:`is turned on<mysql-clustertype>`).
