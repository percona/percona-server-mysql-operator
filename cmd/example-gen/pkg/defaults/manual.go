...
func mysqlDefaults(spec *apiv1.MySQLSpec) {
	podSpecDefaults(&spec.PodSpec, ImageMySQL, resources("4Gi", "2", "8Gi", "4"), configurationMySQL, 600, envList("BOOTSTRAP_READ_TIMEOUT", "600", "ASYNC_SOURCE_RETRY_COUNT", "3", "ASYNC_SOURCE_CONNECT_RETRY", "60", "BOOTSTRAP_CLONE_STALL_TIMEOUT", "900"), envFromList("mysql-env-secret"))
