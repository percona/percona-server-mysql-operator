...
type Instance struct {
	...
	// source — transactions that were never replicated.
	GtidErrant string `json:"GtidErrant"`
	// IsLastCheckValid is false when Orchestrator could not reach the
	// instance on its last poll; the rest of the fields are then stale.
