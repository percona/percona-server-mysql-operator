...
func init() {
	...
	if err := json.Unmarshal([]byte(`["PRODUCT_FAMILY_INVALID","PRODUCT_FAMILY_PS","PRODUCT_FAMILY_PXC","PRODUCT_FAMILY_PSMDB","PRODUCT_FAMILY_PBM","PRODUCT_FAMILY_POSTGRESQL","PRODUCT_FAMILY_PMM","PRODUCT_FAMILY_EVEREST","PRODUCT_FAMILY_PERCONA_TOOLKIT","PRODUCT_FAMILY_PXB","PRODUCT_FAMILY_OPERATOR_PXC","PRODUCT_FAMILY_OPERATOR_POSTGRESQL","PRODUCT_FAMILY_OPERATOR_PSMDB","PRODUCT_FAMILY_OPERATOR_PS"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
