...
func TestContainer(t *testing.T) {
	...
	expectedEnvs := []string{
		"POD_NAME", "POD_NAMESPACE", "CLUSTER_NAME", "CLIENT_PORT_LISTEN", "CLIENT_PORT_MIN",
		"CLIENT_PORT_MAX", "PMM_AGENT_SERVER_ADDRESS", "PMM_AGENT_SERVER_USERNAME", "PMM_AGENT_SERVER_PASSWORD",
		"PMM_AGENT_LISTEN_PORT", "PMM_AGENT_PORTS_MIN", "PMM_AGENT_PORTS_MAX", "PMM_AGENT_CONFIG_FILE",
		"PMM_AGENT_SERVER_INSECURE_TLS", "PMM_AGENT_LISTEN_ADDRESS", "PMM_AGENT_SETUP_NODE_NAME",
