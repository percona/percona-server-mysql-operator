...
func (r *PerconaServerMySQLBackupReconciler) createBackupJob(ctx context.Context, cr *apiv1.PerconaServerMySQLBackup, cluster *apiv1.PerconaServerMySQL, storage *apiv1.BackupStorageSpec, status *apiv1.PerconaServerMySQLBackupStatus) error {
...
func (r *PerconaServerMySQLBackupReconciler) getBackupSource(ctx context.Context, cluster *apiv1.PerconaServerMySQL) (string, error) {
