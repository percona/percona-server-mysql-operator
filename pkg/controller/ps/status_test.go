...
func (c *fakeClient) Exec(ctx context.Context, obj client.Object, containerName string, command []string, stdin io.Reader, stdout, stderr io.Writer, tty bool) error {
