...
// WithToolkitVersion adds the toolkitVersion to the version service product params
func (o *VersionServiceProductParams) WithToolkitVersion(toolkitVersion *string) *VersionServiceProductParams {
	o.SetToolkitVersion(toolkitVersion)
	return o
}

// SetToolkitVersion adds the toolkitVersion to the version service product params
func (o *VersionServiceProductParams) SetToolkitVersion(toolkitVersion *string) {
